  ...
  return (
    <div className="bg-gray-300 flex flex-col items-center min-h-screen">
      <div className="flex flex-col w-full sm:max-w-sm bg-white h-screen pt-8 px-4 overflow-y-auto">
        ...
        {/* <div className="flex  w-full px-4 justify-between fixed bottom-0 ">
          <a href="/dashboard">
            <img className="w-[24px]" src="/icon/home.png" alt="Home" />
          </a>
          <a href="/profile">
            <img className="w-[24px]" src="/icon/profile.png" alt="Profile" />
          </a>
          <a href="/settings">
            <img className="w-[24px]" src="/icon/settings.png" alt="Settings" />
          </a>
        </div> */}
      </div>
    </div>
